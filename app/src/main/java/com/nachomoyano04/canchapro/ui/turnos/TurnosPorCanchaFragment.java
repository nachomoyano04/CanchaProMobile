...
public class TurnosPorCanchaFragment extends Fragment {
    ...
    private TurnosPorCanchaViewModel mViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_turnos_por_cancha, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        mViewModel = new ViewModelProvider(this).get(TurnosPorCanchaViewModel.class);
